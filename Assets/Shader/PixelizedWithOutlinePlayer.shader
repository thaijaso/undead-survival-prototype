...
Shader "ProPixelizer/SRP/Pixelized With Outline Player"
{
    ...
    Properties
    {
		...
		SubShader
		{
			...
			UsePass "ProPixelizer/Hidden/ProPixelizerBasePlayer/UNIVERSAL FORWARD"
			UsePass "ProPixelizer/Hidden/ProPixelizerBasePlayer/SHADOWCASTER"
			UsePass "ProPixelizer/Hidden/ProPixelizerBasePlayer/DEPTHONLY"
			UsePass "ProPixelizer/Hidden/ProPixelizerBasePlayer/DEPTHNORMALS"
		...
		Pass
		{
			...
			#include "Assets/Plugins/ProPixelizer/SRP/PixelUtils.hlsl"
			#include "Assets/Plugins/ProPixelizer/SRP/PackingUtils.hlsl"
			#include "Assets/Plugins/ProPixelizer/SRP/ScreenUtils.hlsl"
			...
			#include "Assets/Plugins/ProPixelizer/SRP/OutlinePass.hlsl"
			ENDHLSL
		}
     }
	CustomEditor "ProPixelizer.PixelizedWithOutlineShaderGUI"
	FallBack "ProPixelizer/Hidden/ProPixelizerBasePlayer"
}
