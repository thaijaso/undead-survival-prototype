...
Shader "ProPixelizer/SRP/PixelizedWithOutline"
{
    ...
    Properties
    {
		...
		[MainTex][NoScaleOffset]_BaseMap("Albedo", 2D) = "white" {}
		_BaseMap_ST("Albedo_ST", Vector) = (1, 1, 0, 0)
		...
		_BumpMap_ST("Normal Map_ST", Vector) = (1, 1, 0, 0)
		[NoScaleOffset]_EmissionMap("Emission", 2D) = "white" {}
		_EmissionMap_ST("Emission_ST", Vector) = (1, 1, 0, 0)
		...
		_EdgeBevelWeight("EdgeBevelWeight", Float) = 0
		[HideInInspector][NoScaleOffset]unity_Lightmaps("unity_Lightmaps", 2DArray) = "" {}
		[HideInInspector][NoScaleOffset]unity_LightmapsInd("unity_LightmapsInd", 2DArray) = "" {}
		[HideInInspector][NoScaleOffset]unity_ShadowMasks("unity_ShadowMasks", 2DArray) = "" {}
		[Toggle]COLOR_GRADING("Use Color Grading", Float) = 0
		[Toggle]USE_OBJECT_POSITION_FOR_PIXEL_GRID("Use Object Position for Pixel Grid", Float) = 0
